...
To access the Bible and start reading, the user should follow these steps on the Bible study page.
...
On the Study Bible page, the user has the options to take notes, highlight verses, bookmark chapters and access to other features **(3)**.
...
Full-screen **(6)** viewing of the Bible is possible. There is also an icon for adjusting the Bible reading Settings **(7)**.
