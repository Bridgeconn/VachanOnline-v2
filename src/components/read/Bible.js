                            ...
                            {verses.map((item) => {
                                ...
                                const verseClass =
                                    selectedVerses.indexOf(verse) > -1
                                        ...
                                        ? `${classes.verseText} ${
                                              colorClasses[highlighMap[verse]]
                                          }`
                                        : `${classes.verseText}`;
                                const verseNumberClass =
                                    verse === 1
                                        ...
                                        : `${classes.verseNumber}`;
                                const verseNo =
                                    verse === 1 ? chapter : item.verseNumber;
                                const sectionHeading = getHeading(
                                    item.contents
                                );
                                return (
